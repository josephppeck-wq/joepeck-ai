      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative">
        ...
        <div className="grid lg:grid-cols-5 gap-12 items-start max-w-5xl mx-auto">
          ...
          >
            ...
            <a href="https://joepeck.ai" className="card p-6 flex items-center gap-4 group block hover:border-accent/30">
              <div className="w-10 h-10 rounded-lg bg-accent/10 border border-accent/20 flex items-center justify-center flex-shrink-0">
                <svg className="w-5 h-5 text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div>
                <div className="text-white/40 text-xs mb-0.5 uppercase tracking-wide">Website</div>
                <div className="text-white/80 text-sm group-hover:text-white transition-colors">joepeck.ai</div>
              </div>
            </a>
