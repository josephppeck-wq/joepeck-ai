        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 pt-12 pb-16">
          <div className="max-w-3xl">
            ...
            <p className="text-white/55 text-lg leading-relaxed">
              I&apos;ve managed $20M+ in ARR quota. The forecast was never right — because we relied on gut feel dressed up in stage names. I built a tool that scores every deal on actual behavioral signals, not what the rep hopes will happen. Below is a live demo with realistic mock pipeline data.
            </p>
          </div>
        </div>
